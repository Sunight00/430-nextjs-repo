...
export default function Page(){
  ...
  <div className="absolute inset-0 flex flex-col md:flex-row items-center justify-center text-black">
    <h1 className={`${Fonts.Headers.className} text-center text-2xl md:text-5xl font-bold`}>Discover Unique Handcrafted Creations</h1>
    <h2 className={`${Fonts.Headers.className} text-center text-xl md:text-3xl font-semibold mt-4 md:mt-0 `}>Support talented artisans by exploring thoughtfully made, one-of-a-kind handmade products.</h2>
  </div>
  ...
  <div className="absolute bottom-8 left-0 right-0 flex flex-col md:flex-row gap-4 items-center justify-center">
    ...
    <Button href="/login" description="Become A Seller" />
  </div>
