...
export  async function DisplayData({query}: query){
    ...
    return(
        ...
        {products.map(product => (
            <div
            key={product.id} className="border border-cyan-200 rounded-md bg-cyan-50 shadow-sm hover:shadow-md transition-shadow duration-150 p-2 flex flex-col items-center text-center">
            {/* Image */}
